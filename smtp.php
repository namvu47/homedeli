...
function SendMail($frommail,$tomail,$subject,$message,$header)
{
      ...
      $smtp_host ='mail.homedeli.vn';//Dia chi mail server
      $admin_email = 'cskh@homedeli.vn';//User duoc khai bao tren mail server
      $smtp_username = 'cskh@homedeli.vn';//User duoc khai bao tren mail server
      $smtp_password = '2qa@QA';//Pass cua email nay
